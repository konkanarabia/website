...
import { updateVisa } from '@/app/actions/visas';
...
export default function EditVisaAdmin({ params }: { params: Promise<{ id: string }> }) {
      ...
      try {
        ...
        if (data.success && data.visa) {
          ...
          setFormData({
            ...
            enquiryLink: s.enquiryLink || '/enquiry/visa',
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const result = await updateVisa(id, fd);
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 md:my-10 bg-white rounded-xl shadow-lg border border-gray-100 font-sans">
      <div className="flex items-center justify-between mb-8">
        <Link href="/admin?tab=visas" className="text-gray-500 hover:text-gray-800 flex items-center gap-2 font-medium">
