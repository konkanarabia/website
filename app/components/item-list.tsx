    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-8 tracking-tighter leading-tight">
          Premium <span className={accentColor.split(' ')[0]}>{title}</span>
        </h1>
      ...
      {items.length > 0 ? (
        ...
        <div className="py-20 text-center bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200">
           <p className="text-slate-400 font-bold italic">No {title.toLowerCase()} available at the moment. Please check back later!</p>
        </div>
      )}
    </div>
  );
